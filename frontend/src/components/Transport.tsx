  ...
  return (
    <div className="h-full flex items-center px-4 space-x-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        <Tooltip content={isPlaying ? "Pause" : "Play"} placement="top" maxWidthClassName="w-24">
          <button
            onClick={onPlay}
        ...
        <Tooltip content="Return to Start" placement="top" maxWidthClassName="w-40">
          <button
            onClick={() => onSeek(0)}
            className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded flex items-center justify-center"
          >
      ...
      {/* Loop Controls */}
      <div className="flex items-center space-x-2">
        <Tooltip content="Loop" placement="top" maxWidthClassName="w-20">
        ...
        <Tooltip content="Metronome" placement="top" maxWidthClassName="w-28">
          <button className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded flex items-center justify-center">
            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
