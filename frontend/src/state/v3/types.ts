...
import type { BarBeat, MeterEvent, TempoEventBB } from "../../time/v3TimelineKernel";
...
export type V3GlobalDefaults = {
  ...
  // extended feel controls (generated MIDI only)
  quantizeStrength?: number;
  quantizeBase?: "16th" | "8th" | "triplet_8th" | "triplet_16th";
...
export type V3ArrangementState = {
  ...
  sectionsBB?: V3ArrangementSectionBB[];
};

export type V3SectionDirective = "simple" | "complex" | "backbeat" | "driving";

export type V3ArrangementSectionBB = {
  id: string;
  label: string;
  start: BarBeat;
  end: BarBeat;
  conf?: number;
  directive?: V3SectionDirective;
};
...
export type V3Actions = {
  ...
  setMeterMap: (meterMap: MeterEvent[]) => void;
  setTempoMapBB: (tempoMapBB: TempoEventBB[]) => void;
  ...
  setSectionsBB: (sections: V3ArrangementSectionBB[] | null) => void;
  ...
  setSnapSectionsToBeat: (on: boolean) => void;
...
export function createDefaultArrangement(): V3ArrangementState {
  return {
    ...
    meterMap: [{ barIndex: 0, num: 4, denom: 4 }],
    tempoMapBB: [{ barIndex: 0, beatInBar: 0, bpm: 120 }],
    beatTimes: undefined,
    beatZeroOffsetSec: 0,
    timeSig: [4, 4],
    sections: [],
