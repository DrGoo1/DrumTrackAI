...
import { generateDrums } from "../api/api";
  ...
  const handleExportMidi = async () => {
    ...
    try {
      ...
      const cfg: DrumGenerationConfig = {
        ...
        fillLocations: [],
        fillType: "auto",
        generationMode: "euclidean" as any,
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="max-w-6xl mx-auto px-4 py-4">
        ...
        {error && (
          <div className="mb-3 bg-red-950/40 border border-red-900/60 text-red-200 rounded p-2 text-sm">{error}</div>
        )}
