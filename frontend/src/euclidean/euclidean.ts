...
export function buildEuclideanEventsForLane(lane: EuclideanLaneConfig, bars: number = 1): EuclideanPatternEvent[] {
...
export function buildEuclideanPattern(lanes: EuclideanLaneConfig[], bars: number): EuclideanPatternEvent[] {
