...
def test_build_sentient_instrument_profile_uses_role_aware_timing_and_dynamics():
    drummer_profile = {
        "instrument_timing_profiles": {
            "profiles": [
                {"instrument": "snare", "role": "backbeat", "subdivision": "1", "mean_offset_ms": 5.0, "std_offset_ms": 2.0, "sample_count": 12},
                {"instrument": "snare", "role": "backbeat", "subdivision": "&", "mean_offset_ms": 1.5, "std_offset_ms": 2.0, "sample_count": 8},
            ]
        },
        "instrument_dynamic_profiles": {
            "profiles": [
                {"instrument": "snare", "role": "backbeat", "velocity_mean": 108.0, "velocity_std": 12.0, "sample_count": 20}
            ]
        },
        "transition_model": {
            "transitions": [
