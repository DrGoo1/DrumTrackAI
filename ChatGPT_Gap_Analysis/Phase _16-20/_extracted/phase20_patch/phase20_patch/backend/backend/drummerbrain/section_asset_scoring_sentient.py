...
def derive_section_asset_scoring(
    ...
    *,
    ...
    """Build section-specific retrieval hints for groove/fill ranking.

    This stays lightweight and additive: it does not require the catalog to be loaded,
    but produces stable scoring hints that a later retrieval layer can consume.
    """
