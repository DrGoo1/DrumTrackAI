...
def performance_spec(req: PerformanceSpecRequest):
    ...
    for idx, sec in enumerate(sections):
        ...
        phrases.append({"phraseId": f"{section_id}_local_service_{idx}", "barStart": bar_start, "barEnd": bar_end, "profiles": profiles, "sectionMeta": phrase_meta})
        ...
        roadmap_sections.append(
            {
                ...
                "transitions": {
                    "fillOut": {
                        ...
                        "family": "auto",
                        "aggression": max(0.0, min(1.0, 0.35 + energy * 0.55 + 0.25 * float(local_transition_bias.get("fill_probability_bias", 0.0)))),
                    },
                    "pickupIntoNext": {
