...
const LandingPage = ({ tiers, navigateTo }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden py-12">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            {/* Main Description - Above Drumset Image */}
            ...
            {/* Drum Image - Clean Professional Drumset */}
            <div className="mb-12">
              <img 
                src="/images/DrumSet_NoBack.png" 
                alt="DrumTracKAI Professional Drumset" 
                className="w-120 h-auto mx-auto"
              />
            </div>
          </div>
          
          {/* Create Human Sounding Drum Tracks - Centered Above Upload */}
          <div className="text-center mb-8">
            <p className="text-4xl font-bold gradient-text-gold">
              Create Realistic Human Sounding Drum Tracks!
            </p>
          </div>
          ...
          {/* Before/After Audio Comparison - Perfectly Centered */}
          <div className="mb-12">
            <div className="text-center mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {/* Before - Typical Drum Software */}
              <div className="bg-white/5 backdrop-blur-md rounded-xl p-6">
                <h3 className="text-xl font-bold text-white mb-3">Typical Drum Software</h3>
              ...
              {/* After - Using DrumTracKAI */}
              <div className="bg-white/5 backdrop-blur-md rounded-xl p-6">
                <h3 className="text-xl font-bold text-white mb-3">Using DrumTracKAI</h3>
                <div className="bg-gray-800 rounded-lg p-3 mb-3">
                  <div className="flex items-center gap-1 mb-2">
          ...
          {/* Beyond Tagline - Positioned Left to Prevent Wrapping */}
          <div className="relative mt-16 mb-16">
            <div className="max-w-7xl mx-auto px-4">
              <div className="text-left ml-8">
                <p className="text-6xl font-bold gradient-text whitespace-nowrap leading-tight py-2">
      ...
      {/* Soul of a Drummer Tagline - Above FAQ */}
